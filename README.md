...
<p align="center">
  <img src="./packages/cascade-studio/icon/sketch.webp" alt="A hand-drawn dot-grid sketch of the bracket with its key dimensions" width="49%">
  <img src="./packages/cascade-studio/icon/bracket.webp" alt="A clean matcap render of the finished bracket" width="49%">
  <img src="./packages/cascade-studio/icon/bracket-wide.jpg" alt="The bracket modeled parametrically in ChiselCAD, driven by labelled sliders in the control panel" width="49%">
  <img src="./packages/cascade-studio/icon/3dprint.webp" alt="The exported bracket laid out on the bed in a 3D-print slicer" width="49%">
</p>
